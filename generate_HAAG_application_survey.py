...
def generate_qualtrics_qsf(data):
    ...
    questions.append({
        ...
        "Payload": {
            ...
            "QuestionDescription": f"Thank you for your interest in The Human-Augmented Analytics (HAAG) OMSCS {semester} research team...",
            "ChoiceOrder": [],
